module.exports.config = {
	...
	description: "تعيين ألقاب تلقائية للأعضاء الجدد"
};
...
module.exports.run = async function({ api, event, Users }) {
	...
	for (let idUser of memJoin) {
		...
		if (thisThread.nameUser.length != 0) {  
			...
			// رسالة للترحيب مع اسم البوت
			api.sendMessage(`✅ تم تعيين لقب مؤقت للعضو الجديد (${namee}) بواسطة ┋ֆ⑉󰟵-BOT-亗‣ᴟ➟mʀasۧۛiɭٰ.🛸󱢏`, threadID);
		} 
	}	
}
